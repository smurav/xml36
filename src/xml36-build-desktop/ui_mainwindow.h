...
**
** Created: Sat Mar 10 19:42:10 2012
...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        attibutes_list = new QTreeWidget(splitter);
        attibutes_list->setObjectName(QString::fromUtf8("attibutes_list"));
        splitter->addWidget(attibutes_list);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        QTreeWidgetItem *___qtreewidgetitem1 = attibutes_list->headerItem();
